...
public class Frmclient extends javax.swing.JDialog {
    ...
    /**
     * Creates new form Frmmaster_client
     * @param parent
     * @param modal
     */
    ...
    private void GetData(){
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("SELECT tmclient.id, tmclient.kode, tmclient.nama, tmclient.no_telp, tmclient.alamat FROM tmclient");
    ...
    private void initComponents() {
        ...
        setTitle("Inventori Barang :: Data Client");
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        if(!"0".equals(row_id)){
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT tmclient.id, tmclient.kode, tmclient.nama, tmclient.no_telp, tmclient.alamat FROM tmclient WHERE tmclient.id='"+row_id+"'");
                if(sql.next()){
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(!"".equals(row_txtkode) && !"".equals(row_txtnama) && !"".equals(row_txttelp) && !"".equals(row_txtalamat)){
             try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT COUNT(tmclient.id) as count FROM tmclient WHERE tmclient.kode='"+row_txtkode+"'");
                sql.next();
            ...
            if("".equals(row_id)){
                if(c_kode == 0)
                {
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("INSERT INTO tmclient(kode, nama, no_telp, alamat) VALUES ('" + row_txtkode + "', '" + row_txtnama + "', '" + row_txttelp + "', '" + row_txtalamat + "')");
                    ...
                    JOptionPane.showMessageDialog(null, "Kode client sudah pernah disimpan.", "Gagal Disimpan", JOptionPane.ERROR_MESSAGE);
                }
            }else{
                if(c_kode == 0 || row_txtkode.equals(row_txttemp_kode))
                {
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("UPDATE tmclient SET kode='" + row_txtkode + "',nama='" + row_txtnama + "',no_telp='" + row_txttelp + "',alamat='" + row_txtalamat + "' WHERE id = '" + row_id + "'");
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(ok==0) {
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("DELETE FROM tmclient WHERE id = '" + row_id + "'");
