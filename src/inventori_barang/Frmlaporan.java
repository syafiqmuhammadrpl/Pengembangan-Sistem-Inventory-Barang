...
public class Frmlaporan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cmbid_laporan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih", "Persedian Barang", "Client", "Barang Masuk", "Barang Keluar" }));
        ...
        switch (id_laporan) {
            ...
            case "Persedian Barang":
                try {                                        
                    ...
                    viewer.setTitle("Laporan Client");
            ...
            case "Client":
                try {
                    File file = new File("src/report/report_client.jrxml");
                    JasperDesign jasperDesign = JRXmlLoader.load(file);
                    JasperReport jasperReport = JasperCompileManager.compileReport(jasperDesign);
                    JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, konek.openkoneksi());
                    //JasperViewer.viewReport(jasperPrint, false);
    ...
    private void cmbid_laporanItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbid_laporanItemStateChanged
        // TODO add your handling code here:
        String id_laporan = cmbid_laporan.getSelectedItem().toString();
        if(id_laporan.equals("Persedian Barang") || id_laporan.equals("Client") || id_laporan.equals("Pilih")){
            dateEnabled(false);
        }else{
            dateEnabled(true);
